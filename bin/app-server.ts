...
const DEFAULT_FILE: string = path.join(DEMO_PATH, 'dist/es2017/app.html');
...
console.info('------------------------------------------------------------------------------------');
console.info('---         This is a small HTTP server to test Yocto-Visualization-4web');
console.info('---      (source code available in Yocto-Visualization-4web/bin/app-server.ts)');
console.info('---');
