...
export class zlib_DeflateState {
    ...
    constructor() {
        ...
        this.method = zlib_constants.Z_DEFLATED; /* can only be DEFLATED */
...
export class zlib_deflate {
    ...
    static lm_init(s) {
        ...
        /*** CLEAR_HASH(s); ***/
        zlib_Pako_trees.zero(s.head); // Fill with NIL (= 0);
    ...
    static deflate(strm, flush) {
        ...
        if (strm.avail_in !== 0 || s.lookahead !== 0 ||
            ...
            if (bstate === zlib_deflate.BS_BLOCK_DONE) {
                ...
                else if (flush !== zlib_constants.Z_BLOCK) { /* FULL_FLUSH or SYNC_FLUSH */
