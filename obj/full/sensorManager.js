...
export class Hub {
    ...
    XmlCode() {
        let NodeLine = "<Hub ";
        if (this._protocol != "")
            NodeLine = NodeLine + "protocol=\"" + YoctoVisualization.constants.XMLquote(this._protocol) + "\" ";
        if (this._user != "")
            NodeLine = NodeLine + "user=\"" + YoctoVisualization.constants.XMLquote(this._user) + "\" ";
        if (this._password != "")
            NodeLine = NodeLine + "password=\"" + YoctoVisualization.constants.XMLquote(this._password) + "\" ";
        NodeLine = NodeLine + "addr=\"" + YoctoVisualization.constants.XMLquote(this._addr) + "\" ";
        if (this._port != "")
            NodeLine = NodeLine + "port=\"" + YoctoVisualization.constants.XMLquote(this.port) + "\" ";
        if (this._path != "")
            NodeLine = NodeLine + "path=\"" + YoctoVisualization.constants.XMLquote(this._path) + "\" ";
        if (!this._removable)
