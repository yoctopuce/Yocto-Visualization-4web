...
export declare class constants {
    ...
    private static _edited;
    static get edited(): boolean;
    static set edited(value: boolean);
    static InitColorHistory(node: YoctoVisualization.YXmlNode): void;
    ...
    static XMLquote(st: string): string;
    static GetXMLConfiguration(): string;
}
...
export declare class sensorsManager {
    ...
    static getXmlHublist(): string;
    static getXMLSensorsConfig(): string;
...
export declare class YWidget {
    ...
    constructor(node: YoctoVisualization.YXmlNode | null, editor: YoctoVisualization.PropertiesForm2 | null, default_x?: number, default_y?: number, default_width?: number, default_height?: number);
    ...
    private static readonly HANDLESIZE;
    private static HandlesDiv;
    private static editHandles;
    private resizeCaptureRunning;
    private resizeCaptureXOrigineMouse;
    private resizeCaptureYOrigineMouse;
    private resizeCaptureXOrigine;
    private resizeCaptureYOrigine;
    private resizeCaptureOriginalTop;
    private resizeCaptureOriginalLeft;
    private resizeCaptureOriginalWidth;
    private resizeCaptureOriginalHeight;
    private resizeCaptureHandleIndex;
    private resizeCaptureOriginalMatrix;
    private resizeCaptureOriginalMatrixInv;
    private static currentEdited;
    get isBeingEdited(): boolean;
    static stopEdition(): void;
    ...
    private touchStartCapture;
    private mouseStartCapture;
    private handleMouseStartCapture;
    private touchCaptureRun;
    private mouseCaptureRun;
    private handleCaptureRun;
    protected editStopped(): void;
    private touchCaptureStop;
    private mouseCaptureStop;
    resize(newWidth: number, newHeight: number): void;
    containerResized(): void;
    getContentsConfigData(): string;
...
export declare class gaugeWidget extends YWidget {
    ...
    constructor(node: YoctoVisualization.YXmlNode | null, editor: YoctoVisualization.PropertiesForm2 | null, x?: number, y?: number, width?: number, height?: number);
    valueFormater(source: YDataRendering.YDataRenderer, value: number): string;
    PropertyChanged2(src: YoctoVisualization.UIElement): void;
    Get_PropertyValue(src: YoctoVisualization.UIElement): any;
    edit(): void;
    protected refreshProperties(): void;
...
export declare class graphWidget extends YWidget {
    ...
    get confirmDeleteString(): string;
    constructor(node: YoctoVisualization.YXmlNode | null, editor: YoctoVisualization.PropertiesForm2 | null, x?: number, y?: number, width?: number, height?: number);
    private editedMarkerWasEnabled;
    private editedMarkerPosition;
    private MarkedCaptureStarted;
    private MarkedCaptureStopped;
    protected refreshProperties(): void;
...
export declare abstract class GenericProperties {
    ...
    getXml(deep: number, o?: Object): string;
...
export declare class YWebPage {
    ...
    private static _mainform;
    private static _saveFunction;
    edit(widgetIndex: number): void;
    private static _editMenuItem;
    static get editMenuItem(): YoctoVisualization.ContextMenuItem;
    private static _deleteMenuItem;
    static get deleteMenuItem(): YoctoVisualization.ContextMenuItem;
    private static _disableMarkerMenuItem;
    static get disableMarkerMenuItem(): YoctoVisualization.ContextMenuItem;
    private static _clearDataloggerMenuItem;
    static get clearDataloggerMenuItem(): YoctoVisualization.ContextMenuItem;
    private static _addMarkerMenuItem;
    static get addMarkerMenuItem(): YoctoVisualization.ContextMenuItem;
    static get markersSubMenuItems(): YoctoVisualization.ContextMenuItemBase[];
    static get contextMarkerSubMenu(): YoctoVisualization.ContextSubMenu;
    static get contextWidgetsSubMenu(): YoctoVisualization.ContextSubMenu;
    ...
    private static WidgetsSubMenuIsOpening;
    private static specificWidgetSubMenuIsOpening;
    ...
    private static deleteWidget;
    static FindUniqueNewName(prefix: string): string;
    static newGraphWidget(): void;
    static newAngularGaugeWidget(): void;
    static newGaugeWidget(): void;
    static newDigitalDisplayWidget(): void;
    static refreshPropertiesForm(): void;
    ...
    private static saveIntDiv;
    static ShowSaveReminder(visible: boolean): void;
    private static loadFromXML;
    private static NewVersionmessageDiv;
    private static AnimateNewVerwsionMessage;
    private static StartInstaller;
    private static DownloadAndStartInstaller;
    private static DeleteNewVersionMessage;
    private static getTopZIndex;
    static CheckForNewVersion(force: boolean): Promise<void>;
    ...
    static refreshEditor(): void;
    static EditObject(widget: YoctoVisualization.YWidget, structData: object, setvalueCallBack: YoctoVisualization.SetValueCallBack2, getvalueCallBack: YoctoVisualization.GetValueCallBack2, EditStoppedCallBack: YoctoVisualization.EditorWasClosedCallback): void;
    static get_XmlData(): string;
    static get readonly(): boolean;
    private static runInternalTest;
    private static save;
    private static handleSavedNotification;
    static Dummysave(xml: string): boolean;
}
...
export declare class YoctoHubFileHandler {
    ...
    private findSourceFileSystem;
    private registerSourceFileSystem;
    private configChangeCallback;
    get configChangeCallbackFct(): ConfigChangeHandler;
    get saveFct(): XMLConfigSaveFunction;
    private retryWithNewCredentials;
    saveFctinternal(xml: string, callback?: XMLConfigSaveFunctionCompleted): Promise<boolean>;
}
...
export declare class mainForm {
    private _window;
    private GUIcoef;
    private static readonly REFWIDH;
    private static readonly REFHEIGHT;
    constructor();
    hide(): void;
    show(): void;
    createButton(container: HTMLTableCellElement, caption: string, icon: string, callback: ButtonClick): void;
    private openConfig;
    private openRawData;
}
export {};
...
import * as YoctoVisualization from "./YoctoVisualizationFull.js";
export interface SetValueCallBack2 {
    (src: UIElement): void;
}
export interface GetValueCallBack2 {
    (src: UIElement): object;
}
export interface GetSummaryCallBack {
    (): string;
}
export interface refreshUIElementListCallback {
    (): any[];
}
export declare class UIElementBaseParams {
    HelpZoneLabel: HTMLDivElement;
    parentNode: YoctoVisualization.EditorBaseDef;
    RootNode: UIElement | null;
    internalname: string;
    label: string;
    description: string;
    changeCausesParentRefresh: boolean;
    preExpanded: boolean;
    expandable: boolean;
    isReadonlyCall: string;
    summary: YoctoVisualization.PropertyDescriptor | null;
    structRoot: any;
    constructor(p_descriptionLabel: HTMLDivElement, p_parentNode: YoctoVisualization.EditorBaseDef, p_RootNode: UIElement | null, p_internalname: string, p_label: string, p_description: string, p_isReadonlyCall: string);
}
export declare class PropPathinfo {
    OriginalPropName: string;
    fullpropname: string;
    propType: string;
}
declare const enum ExpandButtonside {
    LEFT = 0,
    RIGHT = 1
}
export declare class UIElement extends YoctoVisualization.EditorBaseDef {
    static readonly defaultFontFamily: string;
    static readonly defaultFontSize: number;
    protected static readonly ARTIFICIALSECTIONNAME: string;
    name: string;
    protected _targetFullName: string;
    protected static baseheight: number;
    protected static indentation: number;
    protected static expandableShift: number;
    protected static scrollBarWidth: number;
    protected static expandableVerticalOffset: number;
    protected ExpandableDepth: number;
    protected _expanded: boolean;
    protected _expandButtonSide: ExpandButtonside;
    protected _rootEditor: YoctoVisualization.PropertiesForm2 | null;
    protected _helpZoneLabel: HTMLDivElement;
    protected _description: string;
    protected expandCtrl: HTMLAnchorElement | null;
    protected mainlabel: HTMLDivElement | null;
    protected mainText: HTMLSpanElement | null;
    protected subElementPanel: HTMLDivElement | null;
    protected _rootNode: UIElement | null;
    protected _parentNode: YoctoVisualization.EditorBaseDef | null;
    protected _parentPanel: HTMLDivElement | null;
    protected _changeCausesParentRefresh: boolean;
    protected _summaryProperty: YoctoVisualization.PropertyDescriptor | null;
    protected _isReadOnlyCall: string;
    protected _controlsAllocated: boolean;
    protected expandButtonInitDone: boolean;
    protected mainLabelInitDone: boolean;
    protected subElements: UIElement[];
    protected _structRoot: object;
    protected _valueChangeCallback: SetValueCallBack2 | null;
    protected _getValueCallback: GetValueCallBack2 | null;
    protected _shown: boolean;
    protected get parentNode(): UIElement;
    protected get targetFullName(): string;
    protected _summaryCallback: GetSummaryCallBack | null;
    protected get expandIcon(): string;
    protected get colapseIcon(): string;
    removeFromEditor(): void;
    get panel(): HTMLDivElement;
    get editorHelpText(): string;
    get isRootElement(): boolean;
    addToEditor(): void;
    refresh(): void;
    tabReOrder(index: number): number;
    triggerValueChangeCallback(): void;
    private scrollToMakeVisible;
    control_GotFocus(sender: object): void;
    protected control_LostFocus(sender: object): void;
    protected preExpandIfNeeded(): void;
    constructor(p: UIElementBaseParams);
    set rootEditor(value: YoctoVisualization.PropertiesForm2 | null);
    get rootEditor(): YoctoVisualization.PropertiesForm2 | null;
    protected initMainLabel(): void;
    AllocateControls(): void;
    protected initExpandButton(): void;
    get rowHeight(): number;
    ExtractPropPath(info: PropPathinfo): string[];
    startEdit(setcallback: SetValueCallBack2, getCallback: GetValueCallBack2): void;
    stopEdit(): void;
    ...
    getSummary(): string;
    sensorList(): object[];
    ProcessNewType(dataStucture: any): void;
    show(): void;
    hide(): void;
    private ExpandCtrl_Click_expand;
    resizeAll(): void;
    protected _showLabel: boolean;
    get showLabel(): boolean;
    set showLabel(value: boolean);
    protected _expandable: boolean;
    protected _preExpanded: boolean;
    get expandable(): boolean;
    set expandable(value: boolean);
    addSubElement(node: UIElement): void;
    computeHeight(): number;
    resize(top: number, left1: number, left2: number, width: number): number;
}
export declare class UIElementGeneric extends UIElement {
    protected _dataContainer: object;
    protected _prop: YoctoVisualization.PropertyDescriptor;
    protected input: HTMLInputElement | null;
    protected select: HTMLSelectElement | null;
    constructor(p: UIElementBaseParams, dataContainer: object, prop: YoctoVisualization.PropertyDescriptor);
    removeFromEditor(): void;
    tabReOrder(index: number): number;
    addToEditor(): void;
    show(): void;
    checkForReadOnly(): void;
    hide(): void;
    resize(top: number, left1: number, left2: number, width: number): number;
}
/***
 ***  String
 ***/
export declare class UIElementString extends UIElementGeneric {
    constructor(p: UIElementBaseParams, dataContainer: object, prop: YoctoVisualization.PropertyDescriptor);
    AllocateControls(): void;
    refresh(): void;
    private Text_TextChanged;
 ...
 ***  Number
 ***/
export declare class UIElementNumber extends UIElementGeneric {
    constructor(p: UIElementBaseParams, dataContainer: object, prop: YoctoVisualization.PropertyDescriptor);
    AllocateControls(): void;
    refresh(): void;
    private Text_TextChanged;
 ...
 ***  boolean
 ***/
export declare class UIElementBoolean extends UIElementGeneric {
    private _text;
    constructor(p: UIElementBaseParams, dataContainer: object, prop: YoctoVisualization.PropertyDescriptor);
    AllocateControls(): void;
    private updateText;
    refresh(): void;
    private value_TextChanged;
 ...
 ***  DoubleNan
 ***/
export declare class UIElementDoubleNan extends UIElementGeneric {
    constructor(p: UIElementBaseParams, dataContainer: object, prop: YoctoVisualization.PropertyDescriptor);
    AllocateControls(): void;
    refresh(): void;
    private Text_TextChanged;
    protected _value: number;
    get value(): YoctoVisualization.doubleNan;
    set value(value: YoctoVisualization.doubleNan);
    resize(top: number, left1: number, left2: number, width: number): number;
}
/***
 ***  Enums
 ***/
export declare class UIElementEnum extends UIElementGeneric {
    private allValues;
    constructor(p: UIElementBaseParams, dataContainer: object, prop: YoctoVisualization.PropertyDescriptor);
    AllocateControls(): void;
    refresh(): void;
 ...
 ***/
export declare class UIElementList extends UIElementGeneric {
    private _refreshCallback;
    private _indexedValue;
    private allValues;
    private valueType;
 ...
 ***  Color
 ***/
export declare class UIElementColor extends UIElementGeneric {
    private colorSample;
    private colorEditor;
 ...
 ***  UIElementMarkerPos
 ***/
export declare class UIElementMarkerPos extends UIElementGeneric {
...
export interface InputFieldManagerChange {
    (sender: HTMLInputElement, refreshInput: boolean): void;
}
export declare class InputFieldManager {
    private _input;
    private _type;
    private _allowEmpty;
    private _min;
    private _max;
    private _callback;
    static nullCallback(sender: HTMLInputElement): void;
    constructor(input: HTMLInputElement, type: InputFieldManager.dataType, allowEmpty: boolean, min: number, max: number, callback: InputFieldManagerChange | null);
    private showError;
    private clearError;
    backGroundColorFeedback(ErrorMsg: string, state: boolean): boolean;
    checkData(): boolean;
    private InputChange;
}
export declare namespace InputFieldManager {
    const enum dataType {
        DATA_STRING = 0,
        DATA_INT = 1,
        DATA_POSITIVE_INT = 2,
        DATA_STRICT_POSITIVE_INT = 3,
        DATA_FLOAT = 4,
        DATA_POSITIVE_FLOAT = 5,
        DATA_STRICT_POSITIVE_FLOAT = 6,
        DATA_COLOR = 7,
        DATA_PATH = 8,
        DATA_XAXISPOS = 9
    }
...
declare class ColorEditorTab {
    ...
    setTabIndex(index: number): number;
    set active(value: boolean);
    get active(): boolean;
    get tabElement(): HTMLTableCellElement;
    get divElement(): HTMLDivElement;
}
interface ComputeBgColor {
    (source: ColorEditorSroll): string[];
}
interface scrollValueChanged {
    (source: ColorEditorSroll): void;
}
interface sampleSelected {
    (color: YDataRendering.YColor): void;
}
export declare class ColorEditorSroll {
    private _div;
    private _input;
    private _canvasBg;
    private _canvasCursor;
    private _anchor;
    private _value;
    private _colorCallback;
    private _changeCallBack;
    static readonly scrollHeight: number;
    setTabIndex(index: number): number;
    ...
    private TouchStart;
    private TouchCaptureRun;
    private TouchCaptureEnd;
    private MouseDown;
    private handleMouseStartCapture;
    private MouseMove;
    private handleMouseRun;
    mouseWheelEvent(sender: HTMLDivElement, e: WheelEvent): void;
    private KeyDown;
    refresh(): void;
}
export declare class ColorSampler {
    ...
    setTabIndex(index: number): number;
    static checkerboardImage(width: number, height: number): string;
    constructor(containerDiv: HTMLDivElement, selectCallback: sampleSelected | null);
    set color(value: YDataRendering.YColor);
    get color(): YDataRendering.YColor;
}
export declare class colorEditor {
    static _colorHistory: YDataRendering.YColor[];
    static _editorsList: colorEditor[];
    private _container;
    private _table;
    private _tr1;
    private _firstTabIndex;
    private _tr2;
    private _tabRGB;
    private _tabHSL;
    private _tabPredef;
    private _tabStub;
    private _contents;
    private _rgb_R_editor;
    private _rgb_G_editor;
    private _rgb_B_editor;
    private _rgb_T_editor;
    private _hsl_H_editor;
    private _hsl_S_editor;
    private _hsl_L_editor;
    private _hsl_T_editor;
    private _samples;
    private _preview;
    private _prefedDivs;
    private _colorChangeCallback;
    private _memorizeTimer;
    static AddColorToHistory(c: YDataRendering.YColor): void;
    static get colorHistory(): YDataRendering.YColor[];
    get activeBorderColor(): string;
    get inactiveBorderColor(): string;
    get activeColor(): string;
    get inactiveColor(): string;
    get activeBackgroundColor(): string;
    get inactiveBackgroundColor(): string;
    tabSelected(source: ColorEditorTab): void;
    HueScrollBg(): string[];
    SaturationScrollBg(): string[];
    LuminosityScrollBg(): string[];
    HSLTranspScrollBg(): string[];
    RedScrollBg(): string[];
    GreenScrollBg(): string[];
    BlueScrollBg(): string[];
    RGBTranspScrollBg(): string[];
    private static defaultColorHistory;
    destroy(): void;
    refreshColorHistory(): void;
    constructor(container: HTMLDivElement, fontSize: number, initialColor: YDataRendering.YColor, colorChangeCallback: sampleSelected);
    private selectApropriateTab;
    private sampleWasSelectedCallback;
    private initColorMemorization;
    private RgbColorChangeCallBack;
    private HslColorChangeCallBack;
    set color(color: YDataRendering.YColor);
    private AddColorScroll;
    setTabIndex(index: number): number;
}
export {};
...
export declare class configForm {
    private static _window;
    private static GUIcoef;
    private static readonly REFWIDH;
    private static readonly REFHEIGHT;
    private static _contents;
    private static _tabPanelContents;
    private static _table;
    private static _tr1;
    private static _tr2;
    private static _tabNetwork;
    private static _tabCapture;
    private static _tabResources;
    private static _tabUI;
    private static _tabExport;
    private static _tabStub;
    private static fontSize;
    private static _Hubtable;
    private static _selectedHub;
    private static inputPNG;
    private static inputSVG;
    private static inputResolution;
    private static inputSizeSelect;
    private static inputCaptureWidth;
    private static inputCaptureHeight;
    private static inputCaptureWidthInfo;
    private static inputCaptureHeightInfo;
    private static captureHeightTR;
    private static captureWidthTR;
    private static _newButton;
    private static _editButton;
    private static _deleteButton;
    static get activeBorderColor(): string;
    static get inactiveBorderColor(): string;
    static get activeColor(): string;
    static get inactiveColor(): string;
    static get activeBackgroundColor(): string;
    static get inactiveBackgroundColor(): string;
    static hubStateChanged(source: YoctoVisualization.Hub): Promise<void>;
    static RefreshUI(h: YoctoVisualization.Hub): void;
    private static HublineSelected;
    private static newHub;
    private static AddHubToUI;
    static editSelectedHub(): void;
    static deleteSelectedHub(): void;
    static hide(): void;
    static show(): void;
    static DPIoverrideChange(checkbox: HTMLInputElement, input: HTMLInputElement): void;
    static hubWasAdded(hub: YoctoVisualization.Hub): void;
    static hubGotEdited(hub: YoctoVisualization.Hub): void;
    private static dbleClickBringsUpContextMenuChange;
    private static verticalDragZoomChange;
    private static mustCheckForUpdateChange;
    private static maxDataLogRecsChange;
    private static maxSeriesRecsChange;
    private static maxSensorRecsChange;
    private static captureDPIChange;
    private static captureWidthChange;
    private static captureHeightChange;
    private static captureSizeSelectChange;
    private static refreshSizeParams;
    private static downloadCurrentConfig;
    private static captureFormatChange;
    static tabSelected(source: configEditorTab): void;
}
export {};
...
import * as YoctoVisualization from "./YoctoVisualizationFull.js";
export interface HubEditDone {
    (): void;
}
export declare class HubEdit {
    private static readonly FakePassword;
    private static _window;
    private static _contents;
    private static _okButton;
    private static _cancelButton;
    private static _currenthub;
    private static _protocolSelect;
    private static _addressInput;
    private static _portInput;
    private static _pathInput;
    private static _usernameInput;
    private static _passwordInput;
    private static _thisIsEditing;
    private static _whenDone;
    private static _coreWarning;
    private static fontSize;
    static get activeBorderColor(): string;
    static get inactiveBorderColor(): string;
    static get activeColor(): string;
    ...
    static get activeBackgroundColor(): string;
    static get inactiveBackgroundColor(): string;
    static newHub(whenDone: HubEditDone | null): void;
    static editHub(hub: YoctoVisualization.Hub, whenDone: HubEditDone | null): void;
...
export interface CredentialsPromptDone {
    (username: string | null, password: string | null): void;
}
export declare class CredentialsPrompt {
    private static _window;
    private static _contents;
    private static _okButton;
    private static _cancelButton;
    ...
    static show(targeturl: string, whenDone: CredentialsPromptDone | null): void;
    static hide(): void;
    static okClicked(): void;
}
...
// from Editor_rw.d.ts
import * as YoctoVisualization from "./YoctoVisualizationFull.js";
export declare class EditorBaseDef {
    protected refresh(): void;
    protected get panel(): HTMLDivElement | null;
    get expanded(): boolean;
    protected AllocateControls(): void;
}
export interface EditorWasClosedCallback {
    (): void;
}
export declare class PropertiesForm2 extends EditorBaseDef {
    private static readonly HelpHeight;
    private static readonly MinHeightforShowingHelp;
    private _hostWindow;
    private _window;
    private _helpPanel;
    private _container;
    private _editorClosedCallback;
    private EditedDataSourceList;
    private currentEditedDataSource;
    private _changeCallback;
    ...
    addTest(parentDiv: HTMLDivElement): HTMLDivElement;
    private editorIsClosing;
    private bestWidth;
    constructor();
    private windowResized;
    show(): void;
    ...
    refresh(): void;
    refreshBanner(): void;
    showWindow(hostWindow: YoctoVisualization.YWidget, structData: object, setvalueCallBack: YoctoVisualization.SetValueCallBack2, getvalueCallBack: YoctoVisualization.GetValueCallBack2, EditStoppedCallBack: EditorWasClosedCallback): void;
    EditObject(structData: object, setvalueCallBack: YoctoVisualization.SetValueCallBack2, getvalueCallBack: YoctoVisualization.GetValueCallBack2, EditStoppedCallBack: EditorWasClosedCallback): void;
    getConfigData(): string;
    private Form1_SizeChanged;
    private valuechange;
}
...
import * as YoctoAPI from "./YoctoApiFull.js";
export declare class YV4W_installer {
    static readonly HTTP = "http";
    static readonly HTTPS = "https";
    private CALLERISHTTPS;
    private DEFAULT_PROTOCOL;
    private FIRMWAREMINVERSION;
    private DEFAULTADDR;
    private DEFAULTPORT;
    private DEFAULTPATH;
    private DEFAULTCANCELABLE;
    private DEFAULTINTIALFOCUS;
    private readonly DEFAULTUSER;
    private readonly DEFAULTPWD;
    private readonly DEFAULTFILEPREFIX;
    private readonly DEFAULTSRVUSERNAME;
    private readonly DEFAULTSRVPASSORD;
    private _container;
    private _prevButton;
    private _nextButton;
    private _okButton;
    ...
    private _hubAddr;
    private _connectingText;
    private _ipAddrInput;
    private _protocolInput;
    private _ipPortInput;
    private _pathInput;
    private _configFileInput;
    private _webPageInput;
    private _connectiongError;
    private _pwdPanel;
    private _descPanel;
    private _customFilesPanel;
    private _doneMsgContainer;
    private _confirmUninstallPanel;
    private _modInstancesPanel;
    private _donePanel;
    private _runPanel;
    private _modifyInstallPanel;
    private _adminNameInput;
    private _adminPasswordInput;
    private _userNameInput;
    private _userPasswordInput;
    private _useReadOnlyInput;
    private _fileprefixInput;
    private _useFullVersionInput;
    private _removeUnusedJs;
    private _makeDefaultInput;
    private _userCredTable;
    private _optionsPanel;
    private _connectionErrorMsg;
    private _instancesFiles;
    private _jsCodeinstances;
    private _webPageinstances;
    private _uninstallOpt;
    private _updateOpt;
    private _addInstanceOpt;
    private _modInstanceOpt;
    private _confirmUninstall;
    private _history;
    private _ErrMsgContainer;
    private _currentHub;
    private _currentfs;
    private _currentHub_RW_username;
    private _currentHub_RW_password;
    private _currentHub_RO_username;
    private _currentHub_RO_password;
    private _currentHub_protocol;
    private _currentHubLink_protocol;
    private _currentHub_Addr;
    private _currentHub_port;
    private _currentHub_path;
    private _currentHub_ReadOnlyProtected;
    private _warning;
    private _finalURL;
    private _plannedaction;
    private _alreadyInstalled;
    private _applicationURL;
    private readonly ESVersion;
    private readonly WELCOMEPANEL;
    private readonly ENTERHUBADDR;
    private readonly CONNECTINGPANEL;
    private readonly CONNECTIONERROR;
    private readonly PASSWORDPANEL;
    private readonly DESCRIPTIONPANEL;
    private readonly CUSTOMFILESPANEL;
    private readonly OPTIONSPANEL;
    private readonly RUNPANEL;
    private readonly DONEPANEL;
    private readonly MODIFYINSTALLPANEL;
    private readonly CONFIRMUNINSTALLPANEL;
    private readonly MODINSTANCESPANEL;
    private readonly ACTIONINSTALL;
    private readonly ACTIONUNINSTALL;
    private readonly ACTIONADDINSTANCE;
    private readonly ACTIONMODINSTANCE;
    private readonly ACTIONUPDATE;
    private readonly _MODIFYNOTHING;
    private readonly _MODIFYCOMPRESS;
    private readonly _MODIFYUNCOMPRESS;
    private readonly _MODIFYMAKEREADONLY;
    private readonly _MODIFYMAKEREADWRITE;
    private readonly _MODIFYUSEMINIFIED;
    private readonly _MODIFYUSEPLAIN;
    private readonly _MODIFYDELETE;
    private readonly _MODIFYUPDATE;
    private readonly TARGETEXTENSION;
    private readonly icon;
    constructor(container: HTMLElement, options?: any);
    private closeWindow;
    private createNewContentDiv;
    private loadLocalFile;
    private showWelcomePanel;
    private showEnterHubAddr;
    private showConnectingPanel;
    private removeCurrentPanelFromHistory;
    private showConnectionError;
    private MakeSureCredentialsAreNotEmpty;
    private showPasswordPanel;
    private createTextRow;
    private showHubDescription;
    private loadWebPagesList;
    private showModifyInstallPanel;
    private showModInstancesPanel;
    private showCustomFilesPanel;
    private showOptionsPanel;
    private logLine;
    private showRunPanel;
    private checkHTMLfile;
    private checkConfigfile;
    private findChild;
    private patchConfigFile;
    private createHubRecord;
    private getHubConfig;
    private getSeedCode;
    private defaultHTMLfile;
    uploadWidthProgress(str_path: string, bin_content: Uint8Array | string | number[], progress: YoctoAPI.YDownloadProgressCallback): Promise<number>;
    private upgrade;
    private syncJsFile;
    private syncJsFileVersions;
    private setInstanceCredentials;
    private patchPageInstance;
    private uploadpage;
    private modifyInstances;
    private uninstall;
    private get_js_filename;
    private get_js_blob;
    private copyJsCode;
    private install;
    private removeAllChilds;
    private showConfirmUninstallPanel;
    private showDonePanel;
