...
`+Q.escapeXml(e)+`\r
</text>`),r+=t.sizeInPoints*1.75}DrawString(e,t,n,i){if(se._debugDrawString){let r=new k(s.Red,1);this.DrawLineXY(r,i.X-5,i.Y,i.X+5,i.Y),this.DrawLineXY(r,i.X,i.Y-5,i.X,i.Y+5)}this.DrawStringXY(e,t,n,i.X,i.Y)}DrawStringF(e,t,n,i,r){let h=this.MeasureString(e,t,0),o=i.Y+t.size*1.25;switch(r.LineAlignment){case 0:break;case 1:o+=-h.height/2;break;case 2:o+=-h.height;break}let a=e.split(`
...
`+Q.escapeXml(g)+`\r
</text>`),o+=t.sizeInPoints*1.75}}DrawStringRect(e,t,n,i,r){if(se._debugDrawString){let l=new k(s.Red,1);this.DrawRectangle(l,i)}let h=this.MeasureString(e,t,0),o=i.y+t.sizeInPoints*1.1;switch(r.LineAlignment){case 0:break;case 1:o+=(i.h-h.height)/2;break;case 2:o+=i.h-h.height;break}let a=e.split(`
